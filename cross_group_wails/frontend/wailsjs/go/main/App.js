...
export function DetectFanfan(arg1) {
  return window['go']['main']['App']['DetectFanfan'](arg1);
}
...
export function LaunchFanfan(arg1) {
  return window['go']['main']['App']['LaunchFanfan'](arg1);
}
